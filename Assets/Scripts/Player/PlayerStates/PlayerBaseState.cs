...
public abstract class PlayerBaseState
{
    ...
    protected void HandleRotation()
    {
        ...
        float turnOrientation = Mathf.Atan2(_ctx.CurrentMovementInput.x, _ctx.CurrentMovementInput.y) * Mathf.Rad2Deg +
    ...
    protected virtual void HandleMove(bool isInAir = false)
    {
        _appliedMovement.x = _ctx.CurrentMovement.x * _ctx.Acceleration;
        _appliedMovement.y = isInAir ? _appliedMovement.y : _ctx.BaseGravity;
        ...
        _ctx.Animator.SetFloat(_ctx.PlayerVelocityYHash, _ctx.Acceleration * _ctx.CurrentMovementInput.magnitude, 0.1f,
            Time.deltaTime);
    ...
    protected virtual void HandleTargetedMove()
    {
        ...
        Vector3 desiredMovement = (_cameraForward * _ctx.CurrentMovement.z + _cameraRight * _ctx.CurrentMovement.x) *
                                  _ctx.Acceleration;
        ...
        _ctx.Animator.SetFloat(_ctx.PlayerVelocityXHash, _ctx.transform.InverseTransformDirection(_appliedMovement).x,
            0.15f, Time.deltaTime);
        _ctx.Animator.SetFloat(_ctx.PlayerVelocityYHash, _ctx.transform.InverseTransformDirection(_appliedMovement).z,
            0.15f, Time.deltaTime);
    }
