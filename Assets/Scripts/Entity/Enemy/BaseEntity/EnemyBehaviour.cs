...
public class EnemyBehaviour : MonoBehaviour, IEnemyBehave
{
    Rigidbody rb; 
    Animator animator;
    AEnemyAction[] action; // Todas a��es possiveis do personagem
    ...
    AEnemyAction currentAction; // A��o atual do personagem
    ...
    public void SetActions(AEnemyAction[] enemyActions) // Setar as possiveis a��es do personagem (DEV: Tentar incorporar usando um abstract por causa do uso de vari�vel)
    { 
        action = enemyActions;
